...
void setup() {
  size(640, 360);
  files[0] = new SoundFile(this,"a.wav");
  files[1] = new SoundFile(this,"i.wav");
  files[2] = new SoundFile(this,"u.wav");
  files[3] = new SoundFile(this,"e.wav");
  files[4] = new SoundFile(this,"o.wav");
  for(int i=0;i<16;i++){
    rate[i]=pow(2,i/12.0);
  }
}
